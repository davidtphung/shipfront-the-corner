...
- **Logo**: Hard-line isometric box. Faces #000. Stroke #FF6A00. Top + two sides at a front vertical edge.
...
Deployed to GitHub Pages. The site is built with static HTML/CSS/JS for maximum compatibility and performance.
...
No build process required. All files are static and ready to serve.
